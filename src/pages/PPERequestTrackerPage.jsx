            ...
            <table style={{borderCollapse:'separate',borderSpacing:0}}>
              <thead>
                <tr style={{position:'sticky',top:0,zIndex:4}}>
                  <th colSpan={6} style={{background:'#f9fafb',borderBottom:'none',padding:'4px 0'}}></th>
                  ...
                  <th style={{background:'#f9fafb',borderBottom:'none',padding:'4px 0'}}></th>
                  {bulkTarget && <th style={{background:'#f9fafb',borderBottom:'none',padding:'4px 0'}}></th>}
                </tr>
                <tr style={{position:'sticky',top:'29px',zIndex:4}}>
                  <th style={{position:'sticky',left:0,zIndex:5,background:'#f9fafb',minWidth:160}}>Employee</th>
                  <th style={{position:'sticky',left:160,zIndex:5,background:'#f9fafb',minWidth:220,boxShadow:'2px 0 4px rgba(0,0,0,0.08)'}}>PPE/Tool Item</th>
                  <th>Size</th>
                  <th>Qty</th>
                  <th>Location</th>
              ...
              <tbody>
                {groupMode==='po' ? (() => {
                  ...
                  <tr key={r.id} style={{background: bulkTarget && isEligible(r) ? 'rgba(29,158,117,0.05)' : ''}}>
                    ...
                    <td style={{position:"sticky",left:160,zIndex:2,background:"#fff",minWidth:220,boxShadow:"2px 0 4px rgba(0,0,0,0.08)",borderRight:"1px solid #e5e7eb"}}>{r.ppe_name}</td>
                    <td>{r.size_value || '—'}</td>
