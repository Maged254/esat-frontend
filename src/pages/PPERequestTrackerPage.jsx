              ...
              <tbody>
                {groupMode==='po' ? (() => {
                  ...
                  <tr key={r.id} style={{background: bulkTarget && isEligible(r) ? 'rgba(29,158,117,0.05)' : ''}}>
                    ...
                    <td style={{position:"sticky",left:160,zIndex:1,background:"#fff",minWidth:220,maxWidth:220,boxShadow:"2px 0 4px rgba(0,0,0,0.06)"}}>{r.ppe_name}</td>
                    <td>{r.size_value || '—'}</td>
