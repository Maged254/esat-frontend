            ...
            <table style={{borderCollapse:'separate',borderSpacing:0,borderTop:0}}>
              <thead>
                <tr style={{position:'sticky',top:0,zIndex:4,borderBottom:'none',borderTop:'none'}}>
                  ...
                  <th style={{background:'white',border:'none',borderBottom:'none',padding:'4px 0'}}></th>
                  {bulkTarget && <th style={{background:'white',border:'none',borderBottom:'none',padding:'4px 0'}}></th>}
                </tr>
