...
export default function PPERequestTrackerPage() {
  ...
  const delayBadge = (days, bg, color) => days === null ? null : (
    <>
      <div style={{position:'absolute',bottom:0,right:0,width:0,height:0,borderStyle:'solid',borderWidth:'0 0 30px 30px',borderColor:'transparent transparent '+bg+' transparent'}}></div>
      <div style={{position:'absolute',bottom:2,right:2,fontSize:10,fontWeight:600,color:color}}>{days}d</div>
    </>
  );
