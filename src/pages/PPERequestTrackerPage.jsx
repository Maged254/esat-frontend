              ...
              <tbody>
                {groupPO && filters.status === 'ehs_purchase_requested' ? (() => {
                  ...
                  clients.forEach(client => {
                    ...
                    rows.push(<tr key={'client-'+client}><td colSpan={bulkTarget?12:11} style={{background:'#1a3a5c',color:'white',fontWeight:700,fontSize:13,padding:'10px 16px',letterSpacing:'0.04em'}}>{client} <span style={{fontWeight:400,opacity:0.7,fontSize:11}}>({clientRows.length} items)</span></td></tr>);
                    ...
                    rows.push(<tr key={'proj-'+client+proj}><td colSpan={bulkTarget?12:11} style={{background:'#0f2a4a',color:'white',fontWeight:600,fontSize:12,padding:'7px 24px',letterSpacing:'0.03em'}}>{proj} <span style={{fontWeight:400,opacity:0.7,fontSize:11}}>({projRows.length} items)</span></td></tr>);
