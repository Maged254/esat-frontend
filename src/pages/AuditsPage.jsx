  ...
  return (
    <>
      ...
      <div className="content graphs-content" style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.15fr 1fr', gap: 24, marginBottom: 24, minHeight: 420 }}>
          ...
          <div className="card" style={{ display: 'flex', flexDirection: 'column', height: '100%' }}>
            ...
            <div className="card-body" style={{ paddingTop: 20, flex: 1, display: 'flex', flexDirection: 'column', justifyContent: auditorPulse.length === 0 ? 'center' : 'flex-start' }}>
