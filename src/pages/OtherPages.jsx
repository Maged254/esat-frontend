    ...
    <>
      ...
      <div className="content">
        <div className="stat-grid">
          ...
          <div className="stat-card"><div className="stat-label">Pending PMA</div><div className="stat-value navy">{filteredItems.filter(n=>n.status==='ehs_purchase_requested' && n.needs_pda).length}</div></div>
