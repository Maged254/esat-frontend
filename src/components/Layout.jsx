...
const NAV = [
  ...
  { section: 'SCM', roles: ['admin','ehs_manager','scm_officer','supervisor'] },
  { to: '/ppe-tracker', label: 'PPE Tracker', icon: 'ti-shield-check', roles: ['admin','ehs_manager','scm_officer','supervisor'] },
