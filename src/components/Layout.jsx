...
const NAV = [
  { section: 'Overview', roles: ['admin','ehs_officer','ehs_manager','supervisor','project_director'] },
  ...
  { to: '/history', label: 'Audit History', icon: 'ti-history', roles: ['admin','ehs_officer','ehs_manager','supervisor','project_director'] },
  { section: 'Compliance', roles: ['admin','ehs_officer','ehs_manager','supervisor','project_director'] },
  ...
  { to: '/graphs', label: 'Graphs', icon: 'ti-chart-bar', roles: ['admin','ehs_officer','ehs_manager','supervisor','scm_officer','project_director'] },
